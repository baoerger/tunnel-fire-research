...
STAGE4_SRC = PROJECT_ROOT / "阶段四" / "src"
if str(STAGE4_SRC) not in sys.path:
    sys.path.insert(0, str(STAGE4_SRC))
...
def main(argv=None):
    default_runs = PROJECT_ROOT / "阶段一" / "03_网格敏感性" / "runs"
    default_output = PROJECT_ROOT / "阶段一" / "03_网格敏感性" / "derived"
