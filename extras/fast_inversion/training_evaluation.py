...
from extras.legacy_modeling import confidence_intervals
from . import physics_training, set_encoder
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        default=PROJECT_ROOT / "derived" / "network" / "training_evaluation",
    )
