...
from . import direct_inversion


SYNTHETIC_LABEL = "SYNTHETIC_SOFTWARE_TEST_NOT_SCIENTIFIC_EVIDENCE"
NO_RECOMMENDATION = "SOFTWARE_ONLY_NO_LAYOUT_RECOMMENDATION"
DEFAULT_SENSOR_CSV = PROJECT_ROOT / "config" / "reference" / "legacy_sensor_layout.csv"
DEFAULT_SUBSET_CSV = PROJECT_ROOT / "config" / "reference" / "legacy_sparse_subsets.csv"
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        default=PROJECT_ROOT / "derived" / "legacy_modeling" / "fisher_layout",
    )
