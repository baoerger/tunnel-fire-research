...
|---|---:|---:|---:|---:|---:|
| `p_q018_s40_x50_g25_r104729` | 17.9968 MW | 0.018% | 137.0–197.0 s | 5,950.949 s | 818,675,928 B |
| `p_q036_s40_x50_g25_r104729` | 35.9624 MW | 0.105% | 103.0–163.0 s | 6,880.171 s | 903,121,601 B |
...
- 2026-08-20 复核发现旧分析器默认输出 30 s 平均窗，现已按冻结协议改为 60 s；两项仍通过准稳态门，阶段 2 结论不变。
