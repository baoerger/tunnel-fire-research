...
> 当前目标与实测版本：**FDS 6.10.1**（Revision `FDS-6.10.1-0-g12efa16-release`，2026-07-29 本机实跑验证）。
> **本文件中的 FDS 6.10.1 实跑结论优先于项目内旧文档、历史经验、第三方导入器和针对 FDS 6.7/6.8 的旧写法。**
...
- [ ] FDS 日志显示的版本与目标版本一致；当前基准为 FDS 6.10.1。
